//!  A Polygon class.
/*!
  This is the class where the Polygon shape type is made.
*/
...
public:
    ...
    */	
    	Polygon(int id, ShapeType sh, Qt::GlobalColor bColor, Qt::BrushStyle bStyle, Qt::GlobalColor pColor, int width,
	...
	//! A member without argument to get the vector<QPoint> of the shape
	 /*!      
     	   \return The vector<QPoint> of the polygon
          */
